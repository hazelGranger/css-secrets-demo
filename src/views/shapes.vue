			...
			<section id="c-2-5" class="c-section">
				...
				<section>
					<div id="eg-2-5-3">
						...
						<div style="background: #eee;width: 240px;"></div>
					</div>
					<code>
						nav > a{
							position: relative;
				...
				<section>
					...
					<div id="eg-2-6-2">
						<div class="pie">
							...
							<svg viewBox="0 0 32 32">
								<circle r="16" cx="16" cy="16" stroke-dasharray="0 100" class="grow"></circle>
							</svg>
						</div>
					</div>
				</section>
